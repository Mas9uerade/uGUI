...
namespace UnityEngine.UI
{
    ...
    /// </summary>
    public abstract class ForkedLayoutGroup : UIBehaviour, ILayoutElement, ILayoutGroup
    {
        ...
        protected void SetChildAlongAxisWithScale(RectTransform rect, int axis, float pos, float scaleFactor)
        {
            ...
            Debug.LogFormat("SetAnchorPosition : {0}, {1}", rect.gameObject.name, anchoredPosition);
        }
        /// <summary>
        /// Set the position and size of a child layout element along the given axis.
        /// </summary>
        ...
        /// <param name="axis">The axis to set the position and size along. 0 is horizontal and 1 is vertical.</param>
        /// <param name="pos">The position from the left side or top.</param>
        protected void SetChildPositionWithScale(RectTransform rect, Vector2 pos, float scaleFactor)
        {
            if (rect == null)
                return;
            ...
            Vector2 anchoredPosition = rect.anchoredPosition;
            anchoredPosition.x = pos.x + rect.sizeDelta[0] * rect.pivot[0] * scaleFactor;
            anchoredPosition.y = (-pos.y - rect.sizeDelta[1] * (1f - rect.pivot[1]) * scaleFactor);
            rect.anchoredPosition = anchoredPosition;
            Debug.LogFormat("SetAnchorPosition : {0}, {1}", rect.gameObject.name, anchoredPosition);
        }
